        ...
        ( function()
    {
      ...
      var opts = $.extend (true,
      {
        ...
        * aggregate_value.aggregator
        		is a function function(data_indexes) must return aggregated value or null is no data_indexes
        		or standart aggregates like below
        * aggregate_value.aggregator: is 'SUM' - no additioanl params needed
        * 'AVG'
        	 aggregate_value {
                	 aggregator: 'AVG'
        ...
        * 'PERC' - calculate percent from totals.
        ...
        aggregate_value.precision:2  precision:number of digits after digital delimiter,default is 2
        aggregate_value.formatter:callback_function
          function for format values jpv_format_value(value) returns [value,attribute]
         	so we have <td {attribute}>{value}</td>
        *
        */
